          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-4">
              ...
              <button 
                ...
                className={`px-4 py-2 rounded-md text-lg font-medium transition-colors ${activeTab === 'contact' ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-800 hover:bg-gray-200'}`}
              >
                联系我们
              </button>
            </div>
                  ...
                  <table className="w-full border-collapse">
                    <thead>
                      <tr className="bg-gray-100">
                        <th className="border border-gray-300 px-4 py-3 text-left text-lg">尺寸</th>
                        <th className="border border-gray-300 px-4 py-3 text-left text-lg">价格</th>
                      </tr>
                    </thead>
                    <tbody>
                      {category.items.map((item, itemIndex) => (
                        <tr key={itemIndex} className={itemIndex % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                          <td className="border border-gray-300 px-4 py-3 text-lg">{item.size}</td>
                          <td className="border border-gray-300 px-4 py-3 text-lg">{item.price}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
        ...
        <div className="container mx-auto px-4 py-8">
          <section className="bg-white rounded-xl shadow-md p-6 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold text-gray-800 mb-2">店铺地址</h3>
                      <p className="text-lg text-gray-700">安徽省合肥市瑶海区海洲·景秀世家1期乔家喜被</p>
                      <a href="https://maps.google.com" target="_blank" rel="noopener noreferrer" className="mt-2 inline-block text-blue-600 text-lg font-medium hover:underline">
                        查看地图 →
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-xl font-semibold text-gray-800 mb-2">联系电话</h3>
                      <a href="tel:18326180320" className="text-lg text-blue-600 font-medium hover:underline">
                        183-2618-0320
                      </a>
                    </div>
                  </div>
              ...
              <div>
                <img 
                  src="https://trae-api-cn.mchost.guru/api/ide/v1/text_to_image?prompt=quilt%20shop%20interior%20warm%20cozy%20store%20design%20high%20quality&image_size=portrait_4_3" 
                  alt="店铺环境" 
                  className="w-full h-auto rounded-lg shadow-md"
                  loading="lazy"
                />
